...
I study how mountain plants respond to climate change — which species are moving upslope, which are not, and what happens to plant communities when the neighbours change. My PhD at the University of Basel takes a European-scale view of this, combining resurveyed historical vegetation plots with large continental datasets and fieldwork in Norway and Svalbard.

Before Basel I spent three years in Tübingen asking a different kind of question: where, exactly, do grassland plants get their water from? Using stable isotopes, I traced roots to their water sources and found that plants partition the soil more reliably than drought models tend to assume.
